...
void main() {
  ...
  // bpm=45 时一拍 = 60/45 ≈ 1.333s
  // 专项1：8个短音 G4 bpm=45，每拍1.333s，音符时长0.8s
  genSong('drill_8short.wav', [
    ('G4', 0.0,   0.8), ('G4', 1.333, 0.8), ('G4', 2.667, 0.8), ('G4', 4.0,   0.8),
    ('G4', 5.333, 0.8), ('G4', 6.667, 0.8), ('G4', 8.0,   0.8), ('G4', 9.333, 0.8),
  ]);

  // 专项2：4短一长 G4 bpm=45
  genSong('drill_4short1long.wav', [
    ('G4', 0.0,   0.8), ('G4', 1.333, 0.8), ('G4', 2.667, 0.8), ('G4', 4.0, 0.8),
    ('G4', 5.333, 3.2),
  ]);

  // 专项3：长短交替 A4 bpm=45，长音2拍=2.667s，短音1拍=1.333s
  genSong('drill_longshort.wav', [
    ('A4', 0.0,   2.0), ('A4', 2.667, 0.8),
    ('A4', 4.0,   2.0), ('A4', 6.667, 0.8),
    ('A4', 8.0,   2.0), ('A4', 10.667, 0.8),
  ]);

  // 专项4：附点节奏 D5 bpm=45，附点=1.5拍=2.0s，八分=0.5拍=0.667s
  genSong('drill_dotted.wav', [
    ('D5', 0.0,   1.8), ('D5', 2.0,   0.6),
    ('D5', 2.667, 1.8), ('D5', 4.667, 0.6),
    ('D5', 5.333, 1.8), ('D5', 7.333, 0.6),
    ('D5', 8.0,   1.8), ('D5', 10.0,  0.6),
  ]);

  // 专项5：切分节奏 E4 bpm=45，短=0.5拍=0.667s，长=1拍=1.333s
  genSong('drill_syncopation.wav', [
    ('E4', 0.0,   0.6), ('E4', 0.667, 1.2), ('E4', 1.867, 0.6),
    ('E4', 2.667, 0.6), ('E4', 3.333, 1.2), ('E4', 4.533, 0.6),
    ('E4', 5.333, 0.6), ('E4', 6.0,   1.2), ('E4', 7.2,   0.6),
  ]);
